...
#@test Base.return_types(B265_,  (Int, )) == Any[Union{B265{Float64}, B265{Int64}, B265{UInt8}}]
#@test Core.Inference.return_type(B265_,  (Int, )) == Union{B265{Float64}, B265{Int64}, B265{UInt8}}
