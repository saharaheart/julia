...
typedef jl_value_t *(*jl_fptr_linfo_t)(struct _jl_lambda_info_t*, jl_value_t* const*, uint32_t, jl_svec_t*);
...
JL_DLLEXPORT jl_value_t *jl_invoke(jl_lambda_info_t *meth, jl_value_t *const *args, uint32_t nargs);
